const char* Generalspace_code_type[][2] = { {"1000","Administration"},
{"1010","Business, trade"},
...
int Generalspace_code_type_size = sizeof(Generalspace_code_type) / sizeof(char* [2]);

const char* Generalspace_function_type[][2] = {
...
{ "3500","Nuclear Medicine Patient ?œHot??Waiting Room" },
...
int Generalspace_function_type_size = sizeof(Generalspace_function_type) / sizeof(char* [2]);


const char* Transitionspace_code_type[][2] = {
	{"1000","Horizontal Transition"},
	{"1010","Vertical Transition"} 
};
int Transitionspace_code_type_size = sizeof(Transitionspace_code_type) / sizeof(char* [2]);

const char* Transitionspace_function_type[][2] = {
	{"1000","Corridor"},
	{"1010","Breezeway"},
	{"1020","Box Lobby"},
	{"1030","Elevator Lobby"},
...
int Transitionspace_function_type_size = sizeof(Transitionspace_function_type) / sizeof(char* [2]);

const char* Connectionspace_code_type[][2] = {
	{"1000","Door"},
	{"1010","Vestbule"},
	{"1060","Sally port"},
};

int Connectionspace_code_type_size = 3;

const char* Connectionspace_function_type[][2] = {
	{"1000","Door"},
	{"1010","Vestbule"},
	{"1060","Sally port"},
};

int Connectionspace_function_type_size = 3;

const char* Anchorspace_code_type[][2] = {
	{"1000","Vestibule"},
	{"1020","Gate"},
};

int Anchorspace_code_type_size = 2;

const char* Anchorspace_function_type[][2] = {
...
int Anchorspace_function_type_size = 4;